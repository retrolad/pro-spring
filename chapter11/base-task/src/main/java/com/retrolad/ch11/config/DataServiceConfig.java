...
@Configuration
@EnableJpaRepositories(basePackages = "com.retrolad.ch11.repos")
@ComponentScan(basePackages = "com.retrolad.ch11")
public class DataServiceConfig {
    ...
    public EntityManagerFactory entityManagerFactory() {
        ...
        factoryBean.setPackagesToScan("com.retrolad.ch11.entities");
